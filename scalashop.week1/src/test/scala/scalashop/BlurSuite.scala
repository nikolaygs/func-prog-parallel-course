...
class BlurSuite extends FunSuite {
  ...
  test("VerticalBoxBlur.parBlur with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("HorizontalBoxBlur.parBlur with 2 parallel tasks with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur with 4 parallel tasks with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("HorizontalBoxBlur.blur with radius 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
    "4x3 image with one parallel task") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
    ...
    test("HorintalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
      "4x3 image with one parallel task") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
    "4x3 image with 4 parralel tasks") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("HorizontalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
    ...
    HorizontalBoxBlur.parBlur(src, dst, 4, 2)
  ...
  test("VerticalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
    "4x3 image with 20 parralel tasks") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
    ...
    VerticalBoxBlur.parBlur(src, dst, 20, 2)
  ...
  test("HorizontalBoxBlur.parBlur with radius 2 should correctly blur the entire " +
    ...
    HorizontalBoxBlur.parBlur(src, dst, 20, 2)
